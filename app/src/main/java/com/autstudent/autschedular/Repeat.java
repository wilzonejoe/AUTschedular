...
public class Repeat extends AddActivity.PlaceholderFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.activity_repeat, container, false);

        onClickController(rootView);

        titleTV = (TextView) rootView.findViewById(R.id.title_text);
        dayTV = (TextView) rootView.findViewById(R.id.day_text);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ob.put("Day",dayTV.getText().toString());
    ...
    public void onClickController(View rootView) {
        ...
        ImageButton editDay = (ImageButton) rootView.findViewById(R.id.edit_day);
                ...
                alertDialog.setPositiveButton("submit",
                        new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int which) {
                                dayTV.setText(input.getSelectedItem().toString());
                            }
                        });
